...
describe('珠宝工艺专属固定效果', () => {
  it('支持三种已验证强效材料，拒绝相似材料 ID', () => {
    ...
    expect(supportedLiquidEmotionId('Metadata/Items/Currency/EndgameDistilledEmotion2')).toBe(true)
    for (const id of ['Metadata/Items/Currency/EndgameDistilledEmotion4', `${melancholy}0`])
