...
export function parseTargetCraftProject(
  ...
  if (
    ...
    return {
      ok: false,
      error:
        '目标项目必须使用精确的 v74、v75、v76、v77、v78、v79、v80、v81、v82、v83、v84、v85、v86、v87、v88、v89、v90、v91、v92、v93、v94、v95、v96、v97、v98、v99、v100、v101、v102、v103、v104、v105、v106、v107、v108、v109、v110 、v111、v112、v113 、v114、v115 、v116 或 v117 规则版本。',
    }
  const ordinaryAttributeEssences =
    original.rulesVersion === ORDINARY_ATTRIBUTE_ESSENCE_RULES_VERSION
  ...
  if (native) {
    project.rulesVersion = ordinaryAttributeEssences
      ? ORDINARY_ATTRIBUTE_ESSENCE_RULES_VERSION
      : jewelVaal
        ? JEWEL_VAAL_RULES_VERSION
        : defenceEssences
