...
export function parseTargetCraftProject(
  ...
  if (
    ...
    return {
      ok: false,
      error:
        '目标项目必须使用精确的 v74、v75、v76、v77、v78、v79、v80、v81、v82、v83、v84、v85、v86、v87、v88、v89、v90、v91、v92、v93、v94、v95、v96、v97、v98、v99、v100、v101、v102、v103、v104、v105、v106、v107 或 v108 规则版本。',
    }
  const specialMartialRunes = original.rulesVersion === SPECIAL_MARTIAL_RUNE_RULES_VERSION
  ...
  if (native) {
    project.rulesVersion = specialMartialRunes
      ? SPECIAL_MARTIAL_RUNE_RULES_VERSION
      : talismans
        ? TALISMAN_CRAFT_RULES_VERSION
        : flasks
