...
export function socketEffectIncrease(catalog: CraftCatalog, state: CraftState): 0 | 60 {
  return state.affixes.some((affix) => isHorrorSocketAffix(catalog, state, affix)) ? 60 : 0
}
