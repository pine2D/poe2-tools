export const AMULET_SKILL_SOCKETS_RULES_VERSION = 'basic-2026-09-17-v103'
...
/** 孔语义只在项链装备/项目上下文生效；嵌套独立项目使用自己的起点。 */
export function requiresAmuletSkillSocketsProjectVersion(input: unknown): boolean {
