...
export function StrategyTargetCondition({
  ...
  return (
    <div className="strategy-selected-targets">
      ...
      <p>
        选择一至八组；满八组时请先取消一组再选择新目标。要取消最后一组，请删除此条件或改为其他条件。实际数值未知时不计为满足。
      </p>
      <div className="strategy-toolbar">
        <label>
          ...
          >
            {[1, 2, 3, 4, 5, 6, 7, 8].slice(0, condition.targetIds.length).map((count) => (
